<#
  ...
  The id of the GitHub Actions artifact to remove
  .PARAMETER verbosity
  The verbosity level
#>
...
Write-Output "Artifact Id is: $artifactId"
Write-Output "Verbosity is: $verbosity"
Write-Output "GitHub environment is: $env:GITHUB_REPOSITORY"

Write-Output '=========='

if ($artifactId -ne $null -and $artifactId -ne '') {
  Write-Output 'Removing artifact...'
  $url = "/repos/$env:GITHUB_REPOSITORY/actions/artifacts/$artifactId"
  Write-Output "[$artifactId] Url is: $url"
  ...
  Write-Output "[$artifactId] Artifact removed."
}

if ($runId -ne $null -and $runId -ne '') {
